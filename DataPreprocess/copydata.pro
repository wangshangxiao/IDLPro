...
IF thisRelease EQ '5' THEN BEGIN
   files = ['cereb.dat', 'abnorm.dat', 'galaxy.dat', 'jet.dat', 'people.dat', $
               'ctscan.dat', 'head.dat', 'worldelv.dat', 'convec.dat', 'hurric.dat', 'm51.dat']
   xSizes = [512,  64, 256,  81, 192, 256,   80, 360, 248, 440, 340]
   ySizes = [512,  64, 256,  40, 192, 256, 100, 360, 248, 340, 440]
   zSizes = [   1,   15,     1, 101,   2,      1,   57,     1,     1,     1,     1 ]
