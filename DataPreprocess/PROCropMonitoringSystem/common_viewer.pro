...
PRO BAND_SET,Event
	...
	BANDSET_BASE = Widget_Base(GROUP_LEADER=(*PSTATE).WID_BASE_TLB,/COLUMN,Title='波段设置' ,TLB_FRAME_ATTR=1 $
			,SCR_XSIZE=170,SCR_YSIZE=185,XPAD=2,YPAD=2,XOFFSET=w_xoffset,YOFFSET=w_yoffset)
...
PRO COMMON_VIEWER, GROUP_LEADER=wGroup, _EXTRA=_VWBExtra
...
;设置程序初始位置
	...
	WID_BASE_TLB = Widget_Base( GROUP_LEADER=wGroup,/COLUMN,UNAME='WID_BASE_TLB' ,XOFFSET=w_xoffset ,YOFFSET=w_yoffset $
       ,TITLE='图像显示',XPAD=0,YPAD=0,xsize=400,ysize=400,MBAR=SYSTEMMENUBAR,/TLB_KILL_REQUEST_EVENTS,/TLB_SIZE_EVENTS)
...
;工具栏
	WID_BASE_TOOLS = Widget_Base(WID_BASE_TLB,/ROW,/TOOLBAR,XPAD=3,YPAD=0,SPACE=0)
		add_btn = widget_button(WID_BASE_TOOLS, TOOLTIP='打开影像', uname='add_btn', /BITMAP, VALUE='.\Image\open.bmp')
		clear_btn = widget_button(WID_BASE_TOOLS, TOOLTIP='清除', uname='clear_btn', /BITMAP, VALUE='.\Image\close.bmp')
		reset_btn = widget_button(WID_BASE_TOOLS, TOOLTIP='全景', uname='reset_btn', /BITMAP, VALUE='.\Image\globe_7.bmp')
		zoomin_btn = widget_button(WID_BASE_TOOLS, TOOLTIP='固定放大', uname='zoomin_btn', /BITMAP, VALUE='.\Image\zoom_in_page_3.bmp')
		zoomout_btn = widget_button(WID_BASE_TOOLS, TOOLTIP='固定缩小', uname='zoomout_btn', /BITMAP, VALUE='.\Image\zoom_out_page_3.bmp')
		query_btn = widget_button(WID_BASE_TOOLS, TOOLTIP='查看', uname='query_btn', /BITMAP, VALUE='.\Image\information.bmp')

		WID_BASE_Ratio = Widget_Base(WID_BASE_TOOLS,/ROW,/TOOLBAR,/Exclusive,XPAD=0,YPAD=0)
			arrow_btn = widget_button(WID_BASE_Ratio, TOOLTIP='指针', uname='arrow_btn', /BITMAP, VALUE='.\Image\pointer.bmp')
			roam_btn = widget_button(WID_BASE_Ratio, TOOLTIP='漫游', uname='roam_btn', /BITMAP, VALUE='.\Image\hand.bmp')
			zin_btn = widget_button(WID_BASE_Ratio, TOOLTIP='放大', uname='zin_btn', /BITMAP, VALUE='.\Image\zoom_in.bmp')
			zout_btn = widget_button(WID_BASE_Ratio, TOOLTIP='缩小', uname='zout_btn', /BITMAP, VALUE='.\Image\zoom_out.bmp')

	WID_BASE_DRAW = Widget_Base(WID_BASE_TLB,/COLUMN,XPAD=0,YPAD=0)

		WID_DRAW = widget_draw(WID_BASE_DRAW,xsize=400,ysize=400,uname='WID_DRAW',retain=2, $
			/EXPOSE_EVENTS,/BUTTON_EVENTS,GRAPHICS_LEVEL=2)
