; $Id:CGI_FFTNDVI.pro,v 1.2.1 2005/06/16 13:19:52 wita Exp $
;
;+
; NAME: 
;   CGI_FFTNDVI
...
FUNCTION cgi_fftndvi, data, fet=fet, freqs=freqs, range=range, plot=plot, $
  ...
  REPEAT BEGIN
    ...
    data_back=ABS(FFT(datafft*filter, 1))
...
;Check if there is any good data left
  ...
  ;FFT coeffients by two in order to have the correct amplitudes. Except for
  ;The central (zero) harmonic.
  datafft[1:*]=datafft[1:*]*2.
  RETURN, datafft[freqs]
