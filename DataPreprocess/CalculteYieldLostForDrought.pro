PRO CalculteYieldLostForDrought,file1,file2 $
    ...
    ;file1='D:\hunan_sub\mutiplytestdata\syn20130703_rsi_test.tif';级别
    ;file2='D:\hunan_sub\mutiplytestdata\iso20130725.tif';类型
    ...
    FOR iType=0,N_Type-1 DO BEGIN
        ...
        FOR iLevel=0,N_Level-1 DO BEGIN
            PRINT,'干旱级别:',uniqLevel[iLevel],'像元个数：',StatisArray[iType,iLevel]
        ENDFOR
    ENDFOR
END
