...
; NAME:
; 
;   EOSap_Smoothing::handle_bands_select
;
; PURPOSE:
; 
;   This procedure methode is used to update the Smoothing GUI according the selected bands.
;
; AUTHOR:
; 
;   Luc Bertels
...
; CALLING SEQUENCE:
; 
;   Obj->[EOSap_Smoothing::]handle_bands_select
;
; ARGUMENTS 
; 
;   None
...
;
;-------------------------------------------------------------------------
pro EOSap_Smoothing::handle_bands_select
;-------------------------------------------------------------------------
compile_opt strictarr, logical_predicate

  Selected = widget_info(widget_info(self.wWidget, find_by_uname='Wl_Bands'), /list_select)
